...
/* 关键字个数 */
#define norw 16					/*Linsixin 添加了关键字 这里也要改 */ 
/* 名字表容量 */
#define txmax 100
/* 所有的add1用于定义数组 */
...
,forsym,casesym,colon,endcase,lbrace,rbrace 					//32-37	/*LinSixin 增加 forsym casesym endcasesym*/ 
};

#define symnum 38											//LinSixin 增加关键字这里要增加 1 
